...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            extent: [80.060148, 26.347424, 88.204299, 30.467449],
            units: 'degrees'
        })
    })
});
...
map.getView().fit([79.856544, 25.714250, 88.407902, 31.100623], map.getSize());
...
map.on("rendercomplete", function (evt) {
    if (!attributionComplete) {
        ...
        qgis2webAttribution.innerHTML = '<a href="#"></a> ';
        var olAttribution = document.createElement('li');
        olAttribution.innerHTML = '<a href="#"></a> ';
        var qgisAttribution = document.createElement('li');
        qgisAttribution.innerHTML = '<a href="#"></a>';
